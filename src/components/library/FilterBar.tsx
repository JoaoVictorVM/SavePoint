        ...
        className={`
          ...
          ${
            favoritesOnly
              ...
              : "border-[var(--color-border)] text-[var(--color-text-muted)] hover:border-[var(--color-border)]/70"
          }
        `}
      >
        <svg className="w-3.5 h-3.5" fill={favoritesOnly ? "var(--color-gold)" : "none"} stroke="var(--color-gold)" strokeWidth={2} viewBox="0 0 24 24">
