  ...
  return (
    ...
    >
      <div className="p-6 md:p-8 max-w-4xl mx-auto w-full">
        <h1 className="text-2xl font-bold text-[#18181B] mb-8">Run</h1>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Left: Result area */}
          <div className="flex flex-col items-center gap-4">
            <h2 className="text-sm font-medium text-[#71717A] uppercase tracking-wide self-start">Resultado</h2>
            ...
            {isRolling ? (
              ...
              <Link
                ...
                className="group block w-[220px] rounded-[16px] overflow-hidden border border-[#E4E4E7] hover:border-[#06E09B] hover:shadow-lg transition-all duration-200"
              >
                {/* Cover */}
                <div className="relative w-full h-[300px] bg-gradient-to-br from-[#06E09B]/20 to-[#0A0A0B]/10">
                  {result.coverImageUrl && !imgError ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center">
                      <span className="text-5xl font-bold text-[#06E09B]/40">
                ...
                <div className="p-3 bg-white">
                  <p className="text-sm font-semibold text-[#18181B] truncate group-hover:text-[#06E09B] transition-colors">
                    {result.title}
                  </p>
                  <p className="text-xs text-[#71717A] mt-0.5">Clique para ver detalhes →</p>
                </div>
              </Link>
            ) : noResults ? (
              <div className="w-[220px] h-[300px] rounded-[16px] border border-dashed border-[#E4E4E7] flex flex-col items-center justify-center gap-3 text-center p-6">
                <svg className="w-10 h-10 text-[#D4D4D8]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col gap-3">
            <h2 className="text-sm font-medium text-[#71717A] uppercase tracking-wide">Filtros</h2>
            ...
            <button
              type="button"
              onClick={addPair}
              className="w-full py-2.5 rounded-[16px] border border-dashed border-[#E4E4E7] text-sm text-[#71717A] hover:border-[#06E09B] hover:text-[#06E09B] transition-colors cursor-pointer"
            >
              + Adicionar Filtro
            </button>
          </div>
