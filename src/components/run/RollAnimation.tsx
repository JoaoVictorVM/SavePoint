    ...
    <div className="flex flex-col items-center gap-4">
      ...
      >
        ...
        <div style={{ animation: "rollSpin 0.6s linear infinite" }}>
          <svg className="w-16 h-16 text-[var(--color-accent)]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.25}>
        ...
        {/* Scanning line */}
        <div className="w-3/4 h-0.5 bg-[var(--color-accent)]/50 rounded-full" style={{ animation: "scanWidth 0.4s ease-in-out infinite alternate" }} />
      </div>
