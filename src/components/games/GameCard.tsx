...
export function GameCard({
  ...
  return (
    <div className="group relative rounded-[16px] border border-[#E4E4E7] bg-white shadow-[var(--shadow-soft)] hover:shadow-[var(--shadow-medium)] hover:-translate-y-0.5 transition-all duration-200 overflow-hidden">
      {/* Cover image */}
      ...
      <div className="p-4">
        <Link href={`/games/${game.id}`}>
          <h3 className="text-lg font-semibold text-[#18181B] truncate hover:text-[#06E09B] transition-colors">
            {game.title}
          </h3>
        </Link>
