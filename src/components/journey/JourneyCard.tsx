  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute top-2 right-2 w-7 h-7 flex items-center justify-center rounded-full bg-black/30 backdrop-blur-sm hover:bg-[#FF453A]/80 text-white transition-all cursor-pointer opacity-0 group-hover:opacity-100"
